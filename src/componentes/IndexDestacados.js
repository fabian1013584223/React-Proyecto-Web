...
import clipboardimage from "../assets/img/clipboardimage.png";
import clipboardimage1 from "../assets/img/clipboardimage1.png";
import clipboardimage2 from "../assets/img/clipboardimage2.png";
import clipboardimage3 from "../assets/img/clipboardimage3.png";
import clipboardimage5 from "../assets/img/clipboardimage5.png";
import clipboardimage6 from "../assets/img/clipboardimage6.png";
 
const IndexDestacados = () => {
  return (
    <div className="App">
        <header>
        ...
        <div className="container py-4 py-xl-5">
            <div className="row mb-5">
                <div className="col-md-8 col-xl-6 text-center mx-auto">
                    <h2 style={{color: 'var(--bs-link-hover-color)'}}>Destacados</h2>
                    <p></p>
                </div>
            </div>
            <div className="row gy-4 row-cols-1 row-cols-md-2">
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100"><img src={clipboardimage5} width="261" height="161"/></div>
                        <div className="py-4 py-lg-0 px-lg-4">
                            <h4>Últimos lanzamientos</h4>
                            <p>Productos más recientes y vanguardistas</p><a className="bounce animated" href="./DestacadosLanzamientos">Conocer más&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-arrow-right">
                ...
                <div class="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100" style={{textAlign: 'center'}}><img src={clipboardimage} style={{width: '261',height: '161' ,width:'260', height:'160'}}/></div>
                        <div className="py-4 py-lg-0 px-lg-4">
                            <h4>Novedades tecnológicas</h4>
                            <p>Productos que incorporan características o tecnologías innovadoras.</p><a href="./DestacadosNovedades">Conocer más&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-arrow-right">
                                    <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"></path>
                                </svg></a>
                        </div>
                ...
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100"><img src={clipboardimage1} width="262" height="162"/></div>
                        <div className="py-4 py-lg-0 px-lg-4">
                            <h4>Ediciones limitadas</h4>
                            <p>Productos únicos o de colección que están disponibles</p><a href="./DestacadosEdiciones">Conocer más&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-arrow-right">
                                    <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"></path>
                                </svg></a>
                        </div>
                    </div><a class="btn btn-primary mx-auto" role="button" href="./Carrito" style={{color: 'var(--bs-black)', background: '#ffffff80', borderStyle: 'none'}}></a><a href="./Carrito"></a>
                </div>
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100"><img src={clipboardimage2} width="261" height="162"/></div>
                        <div className="py-4 py-lg-0 px-lg-4" style={{marginBottom: '-44px'}}>
                            <h4>Bundles o paquetes</h4>
                            <p>Combinaciones de productos que se venden juntos<a href="./DestacadosBundles">Conocer más&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-arrow-right">
                                        <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"></path>
                                    </svg></a></p>
                        </div>
                ...
                <div className="col-xl-6">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100">
                            <div className="w-100"></div><img src={clipboardimage3} width="261" height="161"/>
                        </div>
                        <div className="py-4 py-lg-0 px-lg-4" style={{marginBottom: '-44px'}}>
                            <h4>Recomendaciones de expertos</h4>
                            <p>Recomendados por expertos en tecnología o reseñas positivas de clientes satisfechos<a href="./DestacadosRecomendaciones">Conocer más&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-arrow-right">
                                        <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"></path>
                                    </svg></a></p>
                        </div>
                    </div><a href="./Carrito"></a><a class="btn btn-primary mx-auto" role="button" href="./Carrito" style={{color: 'var(--bs-black)', background: '#ffffff80', borderStyle: 'none'}}></a>
                ...
                <div className="col-xl-6">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100"><img src={clipboardimage6} width="262" height="169"/></div>
                        <div className="py-4 py-lg-0 px-lg-4" style={{marginBottom: '-44px'}}>
                            <h4>Productos más vendidos</h4>
                            <p>Artículos más populares y solicitados<a href="./DestacadosVendidos">Conocer más&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-arrow-right">
                                        <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"></path>
                                    </svg></a></p>
                        </div>
            ...
            </div><a className="btn btn-primary" role="button" style={{marginRight: '288px',paddingRight: '15px',paddingLeft: '13px',marginLeft: '33px'}} href="./">Atrás</a>
        </div>
    <footer>
...
export default IndexDestacados;