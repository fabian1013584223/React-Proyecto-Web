...
import Adaptador from "../assets/img/Adaptador.webp";
import CargadorIphone from "../assets/img/CargadoriPhone.jpeg";
import Cargadortipoc from "../assets/img/Cargadortipoc.jpeg";
import Lenovousb from "../assets/img/Lenovousb.webp";
 
const CategoriaCargadores = () => {
  return (
    <div className="App">
        <header>
        ...
        <div className="container py-4 py-xl-5">
            <div className="row mb-5">
                <div className="col-md-8 col-xl-6 text-center mx-auto">
                    <h2 style={{color: 'var(--bs-link-hover-color)'}}>Cargadores, Cables, Audifonos y mucho mas</h2>
                    <p></p>
                </div>
            </div>
            <div className="row gy-4 row-cols-1 row-cols-md-2" style={{paddingBottom: '29px'}}>
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100">
                        <img className="mx-auto d-block fit-cover" src={CargadorIphone} style={{width: '261px',  height:'226px'}}/></div>
                        <div className="py-4 py-lg-0 px-lg-4">
                        <h4>Cargador para iPhone</h4>
                            <p>Accesorio esencial para mantener tu dispositivo Apple siempre cargado y listo para usar. </p>
                        </div>
                ...
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        ...
                        <img className="rounded img-fluid d-xl-flex mx-auto justify-content-xl-end align-items-xl-start d-block fit-cover" src={Cargadortipoc}  width="243" height="243" style={{width: '243px'}}/></div>
                        <div className="py-4 py-lg-0 px-lg-4">
                        <h4>Cargador usb tipo c</h4>
                            <p>Accesorio versátil y de carga rápida compatible con una amplia gama de dispositivos electrónicos. </p>
                        </div>
                ...
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100"><img className="rounded img-fluid mx-auto d-block fit-cover" src={Lenovousb}  width="188" height="174" style={{paddingTop: '24px'}}/></div>
                        <div className="py-4 py-lg-0 px-lg-4">
                        <h4>Lenovo USB-C 7-in-1 Hub</h4>
                            <p>Dispositivo versátil que expande la conectividad de tu computadora portátil o dispositivo compatible con USB-C. </p>
                        </div>
                        </div><a href="./Carrito"></a><a className="btn btn-primary mx-auto" role="button" href="./Carrito" style={{color: 'var(--bs-black)',background: '#ffffff80',borderStyle: 'none'}}></a><a href="./Carrito" style={{paddingRight: '0px',marginRight: '-1px',marginLeft: '0px',paddingLeft: '0px'}}></a><a className="btn btn-primary" role="button" style={{overflow: 'visible', color: 'var(--bs-btn-hover-color)',background: 'var(--bs-btn-disabled-color)', borderColor: 'var(--bs-light)'}} href="Agregado alcarrito.html"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-cart3" style={{fontSize: '33px',background: 'var(--bs-light)',bsBodyColor: 'var(--bs-emphasis-color)',bsBodyBg: 'var(--bs-emphasis-color)',borderColor: 'var(--bs-gray-800)', color: 'var(--bs-emphasis-color)'}}>
                            <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"></path>
                        </svg></a>
                ...
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100"><img src={Adaptador} width="201" height="198" style={{width: '201px',height: '198px'}}/></div>
                        <div className="py-4 py-lg-0 px-lg-4" style={{marginBottom: '-44px'}}>
                        <h4>Adaptador de CA Lenovo 65W estándar (USB Type-C)</h4>
                            <p>Accesorio de carga versátil y potente para dispositivos Lenovo compatibles con USB Type-C. </p>
                        </div>
                        </div><a href="./Carrito"></a><a className="btn btn-primary mx-auto" role="button" href="./Carrito" style={{color: 'var(--bs-black)',background: '#ffffff80',borderStyle: 'none'}}></a><a href="./Carrito" style={{paddingRight: '0px',marginRight: '-1px',marginLeft: '0px',paddingLeft: '0px'}}></a><a className="btn btn-primary" role="button" style={{overflow: 'visible', color: 'var(--bs-btn-hover-color)',background: 'var(--bs-btn-disabled-color)', borderColor: 'var(--bs-light)'}} href="Agregado alcarrito.html"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-cart3" style={{fontSize: '33px',background: 'var(--bs-light)',bsBodyColor: 'var(--bs-emphasis-color)',bsBodyBg: 'var(--bs-emphasis-color)',borderColor: 'var(--bs-gray-800)', color: 'var(--bs-emphasis-color)'}}>
                            <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"></path>
                        </svg></a>
...
export default CategoriaCargadores;