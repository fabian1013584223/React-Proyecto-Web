...
import Tecnologia5g from "../assets/img/Tecnologia5g.jpeg";
import virtual from "../assets/img/virtual.jpg";
import Nube from "../assets/img/Nube.png";
import Pantallasplegables from "../assets/img/Pantallasplegables.jpeg";
 
const DestacadosNovedades = () => {
  return (
    <div className="App">
        <header>
        ...
        <div className="container py-4 py-xl-5">
            <div className="row mb-5">
                <div className="col-md-8 col-xl-6 text-center mx-auto">
                    <h2 style={{color: 'var(--bs-link-hover-color)'}}>Novedades Tecnologicas</h2>
                    <p></p>
                </div>
            </div>
            <div className="row gy-4 row-cols-1 row-cols-md-2" style={{paddingBottom: '29px'}}>
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100">
                        <img className="mx-auto d-block fit-cover" src={Tecnologia5g} alt="applewatch" style={{width: '261px',  height:'226px'}}/></div>
                        <div className="py-4 py-lg-0 px-lg-4">
                        <h4>Tecnología 5G</h4>
                        <p>Ultima generación de conectividad móvil que ofrece velocidades de descarga y carga ultrarrápidas, menor latencia y mayor capacidad de conexión simultánea. </p>
                        </div>
                        </div>
                </div>
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        ...
                        <img className="rounded img-fluid d-xl-flex mx-auto justify-content-xl-end align-items-xl-start d-block fit-cover" src={Pantallasplegables} alt='Relojkalley' width="243" height="243" style={{width: '243px'}}/></div>
                        <div className="py-4 py-lg-0 px-lg-4">
                        <h4>Pantallas plegables </h4>
                            <p>Son tecnologías de visualización que permiten que las pantallas sean flexibles y adaptables.&nbsp;</p>
                        </div>
                        </div>
                </div>
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100"><img className="rounded img-fluid mx-auto d-block fit-cover" src={virtual} alt='Accxiaomi' width="188" height="174" style={{paddingTop: '24px'}}/></div>
                        <div className="py-4 py-lg-0 px-lg-4">
                        <h4>Realidad virtual (VR)</h4>
                            <p class="text-start">Tecnología que permite sumergirse en entornos virtuales tridimensionales mediante el uso de cascos o gafas especiales.</p>
                        </div>
                        </div>
                </div>
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100"><img src={Nube} width="201" height="198" style={{width: '201px',height: '198px'}}/></div>
                        <div className="py-4 py-lg-0 px-lg-4" style={{marginBottom: '-44px'}}>
                        <h4>Computación en la nube</h4>
                            <p>Modelo de entrega de servicios de computación a través de Internet. Permite acceder a recursos computacionales, como almacenamiento, servidores y aplicaciones, de forma flexible y bajo demanda, sin necesidad de poseer una infraestructura física local.&nbsp;</p>
                        </div>
                        </div>
                </div>
...
export default DestacadosNovedades;