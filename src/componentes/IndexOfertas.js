...
import Tabletyestuche from "../assets/img/Tabletyestuche.webp";
import Bluetooth5InpodsMAX from "../assets/img/Bluetooth5InpodsMAX.webp";
import productosdeaudio from "../assets/img/productosdeaudio.jpeg";
import Iphone15 from "../assets/img/Iphone15.jpeg";
        ...
        <div className="container py-4 py-xl-5">
            <div className="row mb-5">
                <div className="col-md-8 col-xl-6 text-center mx-auto">
                    <h2 style={{color: 'var(--bs-link-hover-color)'}}>Ofertas</h2>
                    <p></p>
                </div>
            </div>
            <div className="row gy-4 row-cols-1 row-cols-md-2">
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100"><img className="mx-auto d-block fit-cover" src={Iphone15} style={{width: '261px'}} width="261" height="226"/></div>
                        <div className="py-4 py-lg-0 px-lg-4">
                            <h4>Descuento del 20%</h4>
                            <p>todos los smartphones de referencias seleccionadas</p>
                        </div>
                ...
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100" style={{textAlign: 'center'}}><img className="rounded img-fluid d-xl-flex mx-auto justify-content-xl-end align-items-xl-start d-block fit-cover" src={Computador} width="243" height="243" style={{width: '243px'}}/></div>
                        <div className="py-4 py-lg-0 px-lg-4">
                            <h4>50% de descuento</h4>
                            <p>Compra una laptop y recibe el 50% de descuento&nbsp;<span style={{color: 'rgb(55, 65, 81)',backgroundColor: 'rgb(247, 247, 248)'}}>en un mouse inalámbrico</span></p>
                        </div>
                        </div><a className="btn btn-primary mx-auto" role="button" href="./Carrito" style={{color: 'var(--bs-black)',background: '#ffffff80',borderStyle: 'none'}}></a><a href="./Carrito" style={{paddingRight: '0px',marginRight: '-1px',marginLeft: '0px',paddingLeft: '0px'}}></a><a className="btn btn-primary" role="button" style={{overflow: 'visible', color: 'var(--bs-btn-hover-color)',background: 'var(--bs-btn-disabled-color)', borderColor: 'var(--bs-light)'}} href="Agregado alcarrito.html"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-cart3" style={{fontSize: '33px',background: 'var(--bs-light)',bsBodyColor: 'var(--bs-emphasis-color)',bsBodyBg: 'var(--bs-emphasis-color)',borderColor: 'var(--bs-gray-800)', color: 'var(--bs-emphasis-color)'}}>
                            <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"></path>
                        </svg></a>
                ...
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100"><img className="rounded img-fluid mx-auto d-block fit-cover" src={Bluetooth5InpodsMAX} width="188" height="174" style={{paddingTop: '24px'}}/></div>
                        <div className="py-4 py-lg-0 px-lg-4">
                            <h4>Descuento del 15%</h4>
                            <p>En todos los auriculares Bluetooth de alta calidad.</p>
                        </div>
                        </div><a className="btn btn-primary mx-auto" role="button" href="./Carrito" style={{color: 'var(--bs-black)',background: '#ffffff80',borderStyle: 'none'}}></a><a href="./Carrito" style={{paddingRight: '0px',marginRight: '-1px',marginLeft: '0px',paddingLeft: '0px'}}></a><a className="btn btn-primary" role="button" style={{overflow: 'visible', color: 'var(--bs-btn-hover-color)',background: 'var(--bs-btn-disabled-color)', borderColor: 'var(--bs-light)'}} href="Agregado alcarrito.html"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-cart3" style={{fontSize: '33px',background: 'var(--bs-light)',bsBodyColor: 'var(--bs-emphasis-color)',bsBodyBg: 'var(--bs-emphasis-color)',borderColor: 'var(--bs-gray-800)', color: 'var(--bs-emphasis-color)'}}>
                            <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"></path>
                        </svg></a>
                ...
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100"><img src={productosdeaudio} width="206" height="175"/></div>
                        <div className="py-4 py-lg-0 px-lg-4" style={{marginbottom: '-44px'}}>
                            <h4>Descuento del 20%</h4>
                            <p>En todos los productos de audio, incluyendo altavoces y barras de sonido.</p>
                        </div>
                ...
                <div class="col">
                    <div class="d-flex flex-column flex-lg-row">
                        <div class="w-100"><img src={Sonya7IIMirrorlessCamera} width="206" height="175"/></div>
                        <div class="py-4 py-lg-0 px-lg-4" style={{marginbottom: '-44px'}}>
                            <h4>Oferta especial</h4>
                            <p>Lleva una cámara digital y recibe una tarjeta de memoria de 32GB de regalo.</p>
                        </div>
                        </div><a href="./Carrito"></a><a className="btn btn-primary mx-auto" role="button" href="./Carrito" style={{color: 'var(--bs-black)',background: '#ffffff80',borderStyle: 'none'}}></a><a href="./Carrito" style={{paddingRight: '0px',marginRight: '-1px',marginLeft: '0px',paddingLeft: '0px'}}></a><a className="btn btn-primary" role="button" style={{overflow: 'visible', color: 'var(--bs-btn-hover-color)',background: 'var(--bs-btn-disabled-color)', borderColor: 'var(--bs-light)'}} href="Agregado alcarrito.html"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-cart3" style={{fontSize: '33px',background: 'var(--bs-light)',bsBodyColor: 'var(--bs-emphasis-color)',bsBodyBg: 'var(--bs-emphasis-color)',borderColor: 'var(--bs-gray-800)', color: 'var(--bs-emphasis-color)'}}>
                            <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"></path>
                        </svg></a>
                ...
                <div class="col">
                    <div class="d-flex flex-column flex-lg-row">
                        <div class="w-100"><img src={Tabletyestuche} width="206" height="175"/></div>
                        <div class="py-4 py-lg-0 px-lg-4" style={{marginbottom: '-44px'}}>
                            <h4>Oferta especial</h4>
                            <p>Compra una tablet y recibe un estuche protector de regalo.</p>
                        </div>
                        </div><a href="./Carrito"></a><a className="btn btn-primary mx-auto" role="button" href="./Carrito" style={{color: 'var(--bs-black)',background: '#ffffff80',borderStyle: 'none'}}></a><a href="./Carrito" style={{paddingRight: '0px',marginRight: '-1px',marginLeft: '0px',paddingLeft: '0px'}}></a><a className="btn btn-primary" role="button" style={{overflow: 'visible', color: 'var(--bs-btn-hover-color)',background: 'var(--bs-btn-disabled-color)', borderColor: 'var(--bs-light)'}} href="Agregado alcarrito.html"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-cart3" style={{fontSize: '33px',background: 'var(--bs-light)',bsBodyColor: 'var(--bs-emphasis-color)',bsBodyBg: 'var(--bs-emphasis-color)',borderColor: 'var(--bs-gray-800)', color: 'var(--bs-emphasis-color)'}}>
                            <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"></path>
                        </svg></a>
                </div>
            </div><a class="btn btn-primary" role="button" style={{marginRight: '288px',paddingRight: '15px',paddingLeft: '13px',marginLeft: '33px'}} href="./">Atrás</a>
        </div>
    <footer>
