...
const Nosotros = () => {
  ...
  <div className="container">
    <h1 style={{ paddingTop: '35px', marginBottom: '29px', textAlign: 'center' }}>Nosotros&nbsp;</h1>
    <p style={{ textAlign: 'center' }}>SISI es una empresa creada en el año 2010, dirigida a la tecnología, otorgando a la sociedad los mejores productos tecnológicos de calidad y con un muy buen precio en el mercado. Actualmente nos encontramos ubicados en la localidad de Chapinero en la zona comercial de la ciudad y tenemos una distribución en toda la ciudad de Bogotá.&nbsp;</p>
