...
import audifonoIna from "../assets/img/audifonoIna.jpg";
import mouse from "../assets/img/mouse.jpg";
import Celularr from "../assets/img/Celularr.jpg";
...
const Carrito = () => {
  return (
    <div className="App">
        ...
        <div className="table-responsive" style={{marginLeft: '32px', marginRight: '33px', marginTop: '39px', paddingBottom: '0px', marginBottom: '2px'}}>
            <table className="table">
                <thead>
                    <tr>
                        <th style={{background: 'var(--bs-table-border-color)', color: 'var(--bs-table-striped-color)'}}>Imagen</th>
                        <th style={{background: 'var(--bs-table-border-color)'}}>Producto</th>
                        <th style={{background: 'var(--bs-table-border-color)'}}>Cantidad</th>
                        <th style={{background: 'var(--bs-table-border-color)'}}>Precio/unidad</th>
                        <th style={{background: 'var(--bs-table-border-color)'}}>Estado</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td><img src={portatil} alt="portatil" width="153" height="124" /></td>
                        <td>Computador</td>
                        <td>2</td>
                        <td>2'600.000</td>
                        <td>Si/No</td>
                    ...
                    <tr>
                        <td><img src={Audifonos} alt="Audifonos" width="154" height="121"/></td>
                        <td>Audífonos&nbsp;</td>
                        <td>1</td>
                        <td>350.000</td>
                        <td>Si/No</td>
                    ...
                    <tr>
                        <td><img src={Celularr} alt="Celularr" width="145" height="123"/></td>
                        <td>Celular</td>
                        <td>1</td>
                        <td>1'200.000</td>
                        <td>Si/No</td>
                    ...
                    <tr>
                        <td><img src={audifonoIna} alt="audifonoIna" width="136" height="120"/></td>
                    ...
                    <tr>
                        <td><img src={TecladoMause} alt="Tecladomause" width="136" height="120"/></td>
                        <td>Teclado</td>
                        <td>1</td>
                        <td>150.000</td>
                        <td>Si/No</td>
                    ...
                    <tr>
                        <td><img src={mouse} alt="mouse" width="145" height="134"/></td>
                        <td>Mouse</td>
                        <td>1</td>
                        <td>50.000</td>
                        <td>Si/No</td>
                    ...
                    <tr>
                        <td><img src={tabletlenovo} alt="tabletlenovo" width="155" height="129"/></td>
                        <td>Tablet</td>
                        <td>3</td>
                        <td class="border-primary">1'500.000</td>
                        <td>Si/No</td>
                    </tr>
                </tbody>
            </table>
    ...
    <div className="row">
        <div className="col d-xl-flex justify-content-xl-start align-items-xl-center" style={{paddingBottom: '22px'}}><a className="btn btn-primary" role="button" style={{marginLeft: '42px'}} href='./TablaProductos'>Continuar compra</a></div>
        <div className="col"></div>
        <div className="col d-xl-flex justify-content-xl-end align-items-xl-center" style={{paddingBottom: '0px',marginBottom: '25px'}}><a className="btn btn-primary" role="button" style={{marginLeft: '-3px', paddingRight: '11px',marginRight: '42px'}} href='./TablaProductos'>Realizar compra</a></div>
    </div>
