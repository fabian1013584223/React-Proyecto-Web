...
const LoginForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!email || !password) {
      alert('Los campos de correo electrónico y contraseña son obligatorios.');
    } else {
      alert('Email: ' + email);
                ...
                <div className="container">
                    <div className="row mb-5">
                        <div className="col-md-8 col-xl-6 text-center mx-auto">
                            <h2>Administrador</h2>
                            <p>Seleccione el tipo de registro que desee visualizar del control de inventarios de la empresa.&nbsp;</p>
                        </div>
                    </div>
                    <div className="row d-flex justify-content-center" style={{paddingTop: '0px',marginTop: '-30px'}}>
                        <div className="col-md-6 col-xl-4"><a className="btn btn-primary" role="button" style={{textAlign: 'center',marginLeft: '90px',width: '150px',marginBottom: '32px',paddingBottom: '10px',borderColor: 'var(--bs-white)'}} href="./Usuarios">&nbsp;Usuarios</a>
                        <a className="btn btn-primary" role="button" style={{textAlign: 'center',marginLeft: '90px',width: '150px',marginBottom: '33px',paddingBottom: '10px',borderColor: 'var(--bs-cyan)'}} href="./Precios">Precios</a>
                        <a className="btn btn-primary" role="button" style={{textAlign: 'center',marginLeft: '90px',width: '150px',marginBottom: '33px',paddingBottom: '10px',borderColor: 'var(--bs-cyan)'}} href="./Cliente">Clientes</a>
                        ...
                        <a className="btn btn-primary" role="button" style={{textAlign: 'center',marginLeft: '90px',width: '150px',marginBottom: '33px',paddingBottom: '10px',borderColor: 'var(--bs-cyan)'}} href="./Factura">Factura</a></div>
                    </div>
                </div>
            </section>
        </div>
                    ...
                    <div className="col">
                        <ul className="list-inline my-2">
                            <li className="list-inline-item me-4">
                                <div className="person-circle-outline"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-facebook">
