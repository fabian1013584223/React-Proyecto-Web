...
import SamsungS21 from "../assets/img/SamsungS21.jpeg";
import MacBookAirChip from "../assets/img/MacBookAirChip.jpeg";
import procesadorryzen from "../assets/img/procesadorryzen.webp";
import tabletlenovo from "../assets/img/tabletlenovo.jpg";
import AppleWatch7 from "../assets/img/AppleWatch7.jpeg";
import PlayStation5 from "../assets/img/PlayStation5.jpeg";
 
const DestacadosLanzamientos = () => {
  return (
    <div className="App">
        <header>
        ...
        <div className="container py-4 py-xl-5">
            <div className="row mb-5">
                <div className="col-md-8 col-xl-6 text-center mx-auto">
                    <h2 style={{color: 'var(--bs-link-hover-color)'}}>Ultimos Lanzamientos</h2>
                    <p></p>
                </div>
            </div>
            <div className="row gy-4 row-cols-1 row-cols-md-2" style={{paddingBottom: '29px'}}>
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100">
                        <img className="mx-auto d-block fit-cover" src={SamsungS21} alt="applewatch" style={{width: '261px',  height:'226px'}}/></div>
                        <div className="py-4 py-lg-0 px-lg-4">
                        <h4>Samsung Galaxy S21</h4>
                            <p>Teléfono inteligente de alta gama con pantalla grande, potente rendimiento, cámara versátil y diseño elegante.</p>
                        </div>
                ...
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        ...
                        <img className="rounded img-fluid d-xl-flex mx-auto justify-content-xl-end align-items-xl-start d-block fit-cover" src={MacBookAirChip} alt='Relojkalley' width="243" height="243" style={{width: '243px'}}/></div>
                        <div className="py-4 py-lg-0 px-lg-4">
                        <h4>Apple MacBook Pro 13 Pulgadas </h4>
                        <p>otente y portátil computadora portátil con una excelente pantalla, gran rendimiento y diseño elegante. </p>
                        </div>
                ...
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100"><img className="rounded img-fluid mx-auto d-block fit-cover" src={PlayStation5} alt='Accxiaomi' width="188" height="174" style={{paddingTop: '24px'}}/></div>
                        <div className="py-4 py-lg-0 px-lg-4">
                        <h4>PlayStation 5</h4>
                            <p>Consola de videojuegos de última generación con gráficos de alta calidad, rendimiento potente, capacidad de juego en 4K y una amplia biblioteca de juegos emocionantes y envolventes para disfrutar.</p>
                        </div>
                        </div><a href="./Carrito"></a><a className="btn btn-primary mx-auto" role="button" href="./Carrito" style={{color: 'var(--bs-black)',background: '#ffffff80',borderStyle: 'none'}}></a><a href="./Carrito" style={{paddingRight: '0px',marginRight: '-1px',marginLeft: '0px',paddingLeft: '0px'}}></a><a className="btn btn-primary" role="button" style={{overflow: 'visible', color: 'var(--bs-btn-hover-color)',background: 'var(--bs-btn-disabled-color)', borderColor: 'var(--bs-light)'}} href="Agregado alcarrito.html"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-cart3" style={{fontSize: '33px',background: 'var(--bs-light)',bsBodyColor: 'var(--bs-emphasis-color)',bsBodyBg: 'var(--bs-emphasis-color)',borderColor: 'var(--bs-gray-800)', color: 'var(--bs-emphasis-color)'}}>
                            <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"></path>
                        </svg></a>
                ...
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100"><img src={procesadorryzen} width="201" height="198" style={{width: '201px',height: '198px'}}/></div>
                        <div className="py-4 py-lg-0 px-lg-4" style={{marginBottom: '-44px'}}>
                        <h4>Procesador ryzen serie 7000</h4>
                            <p class="text-start">Línea de procesadores de alto rendimiento fabricados por AMD, diseñados para ofrecer un rendimiento potente y eficiente en tareas exigentes, como gaming y aplicaciones de productividad.</p>
                        </div>
                        </div><a href="./Carrito"></a><a className="btn btn-primary mx-auto" role="button" href="./Carrito" style={{color: 'var(--bs-black)',background: '#ffffff80',borderStyle: 'none'}}></a><a href="./Carrito" style={{paddingRight: '0px',marginRight: '-1px',marginLeft: '0px',paddingLeft: '0px'}}></a><a className="btn btn-primary" role="button" style={{overflow: 'visible', color: 'var(--bs-btn-hover-color)',background: 'var(--bs-btn-disabled-color)', borderColor: 'var(--bs-light)'}} href="Agregado alcarrito.html"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-cart3" style={{fontSize: '33px',background: 'var(--bs-light)',bsBodyColor: 'var(--bs-emphasis-color)',bsBodyBg: 'var(--bs-emphasis-color)',borderColor: 'var(--bs-gray-800)', color: 'var(--bs-emphasis-color)'}}>
                            <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"></path>
                        </svg></a>
                ...
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100"><img src={tabletlenovo} width="206" height="175"/></div>
                        <div className="py-4 py-lg-0 px-lg-4" style={{marginBottom: '-44px'}}>
                        <h4>Tablet LENOVO 11" Pulgadas P11 Pro Wifi</h4>
                        <p>Dispositivo portátil con una pantalla grande y nítida, conectividad Wifi, y potentes capacidades que la hacen ideal para el entretenimiento, productividad y navegación web.</p>
                        </div>
                        </div><a href="./Carrito"></a><a className="btn btn-primary mx-auto" role="button" href="./Carrito" style={{color: 'var(--bs-black)',background: '#ffffff80',borderStyle: 'none'}}></a><a href="./Carrito" style={{paddingRight: '0px',marginRight: '-1px',marginLeft: '0px',paddingLeft: '0px'}}></a><a className="btn btn-primary" role="button" style={{overflow: 'visible', color: 'var(--bs-btn-hover-color)',background: 'var(--bs-btn-disabled-color)', borderColor: 'var(--bs-light)'}} href="Agregado alcarrito.html"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-cart3" style={{fontSize: '33px',background: 'var(--bs-light)',bsBodyColor: 'var(--bs-emphasis-color)',bsBodyBg: 'var(--bs-emphasis-color)',borderColor: 'var(--bs-gray-800)', color: 'var(--bs-emphasis-color)'}}>
                            <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"></path>
                        </svg></a>
                ...
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100"><img src={AppleWatch7} width="217" height="170"/></div>
                        <div className="py-4 py-lg-0 px-lg-4" style={{marginBottom: '-44px'}}>
                        <h4>Apple Watch Series 7</h4>
                            <p>Reloj inteligente de última generación con una pantalla más grande, diseño elegante y una amplia gama de características y funciones, incluyendo seguimiento de actividad física, notificaciones en tiempo real y compatibilidad con aplicaciones de salud y bienestar</p>
                        </div>
                        </div><a href="./Carrito"></a><a className="btn btn-primary mx-auto" role="button" href="./Carrito" style={{color: 'var(--bs-black)',background: '#ffffff80',borderStyle: 'none'}}></a><a href="./Carrito" style={{paddingRight: '0px',marginRight: '-1px',marginLeft: '0px',paddingLeft: '0px'}}></a><a className="btn btn-primary" role="button" style={{overflow: 'visible', color: 'var(--bs-btn-hover-color)',background: 'var(--bs-btn-disabled-color)', borderColor: 'var(--bs-light)'}} href="Agregado alcarrito.html"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-cart3" style={{fontSize: '33px',background: 'var(--bs-light)',bsBodyColor: 'var(--bs-emphasis-color)',bsBodyBg: 'var(--bs-emphasis-color)',borderColor: 'var(--bs-gray-800)', color: 'var(--bs-emphasis-color)'}}>
                            <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"></path>
                        </svg></a>
                </div>
                </div><a class="btn btn-primary" role="button" style={{marginTight: '288px',paddingRight: '15px',paddingLeft: '13px', marginLeft: '33px'}} href="./IndexDestacados">Atrás</a>
        </div>
    <footer>
...
export default DestacadosLanzamientos;