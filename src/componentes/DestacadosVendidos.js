...
import Audifonos from "../assets/img/Audifonos.jpg";
import airpodsmax from "../assets/img/airpodsmax.jpeg";
import Gopro from "../assets/img/Gopro.jpeg";
 
const DestacadosVendidos = () => {
  return (
    <div className="App">
        <header>
            ...
            <div className="row gy-4 row-cols-1 row-cols-md-2" style={{paddingBottom: '29px'}}>
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100">
                        <img className="mx-auto d-block fit-cover" src={Accsamsung} alt="applewatch" style={{width: '261px',  height:'226px'}}/></div>
                        <div className="py-4 py-lg-0 px-lg-4">
                        <h4>Reloj SAMSUNG Galaxy Watch 5 de 44 mm </h4>
                            <p>Ofrece seguimiento de actividad física, monitorización de la salud y notificaciones en tiempo real. </p>
                        </div>
                ...
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        ...
                        <img className="rounded img-fluid d-xl-flex mx-auto justify-content-xl-end align-items-xl-start d-block fit-cover" src={Audifonos} alt='Relojkalley' width="243" height="243" style={{width: '243px'}}/></div>
                        <div className="py-4 py-lg-0 px-lg-4">
                        <h4>Sony WH-1000XM4 </h4>
                            <p>auriculares inalámbricos con cancelación de ruido líder en la industria..</p>
                        </div>
                ...
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100"><img className="rounded img-fluid mx-auto d-block fit-cover" src={airpodsmax} alt='Accxiaomi' width="188" height="174" style={{paddingTop: '24px'}}/></div>
                        <div className="py-4 py-lg-0 px-lg-4">
                        <h4>Airpods max</h4>
                            <p class="text-start">Ofrecen una calidad de sonido excepcional, cancelación activa de ruido, un diseño elegante con materiales de alta calidad y una comodidad superior gracias a sus almohadillas suaves y ajustables. </p>
                        </div>
                        </div><a href="./Carrito"></a><a className="btn btn-primary mx-auto" role="button" href="./Carrito" style={{color: 'var(--bs-black)',background: '#ffffff80',borderStyle: 'none'}}></a><a href="./Carrito" style={{paddingRight: '0px',marginRight: '-1px',marginLeft: '0px',paddingLeft: '0px'}}></a><a className="btn btn-primary" role="button" style={{overflow: 'visible', color: 'var(--bs-btn-hover-color)',background: 'var(--bs-btn-disabled-color)', borderColor: 'var(--bs-light)'}} href="Agregado alcarrito.html"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-cart3" style={{fontSize: '33px',background: 'var(--bs-light)',bsBodyColor: 'var(--bs-emphasis-color)',bsBodyBg: 'var(--bs-emphasis-color)',borderColor: 'var(--bs-gray-800)', color: 'var(--bs-emphasis-color)'}}>
                            <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"></path>
                        </svg></a>
                ...
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100"><img src={Gopro} width="206" height="175"/></div>
                        <div className="py-4 py-lg-0 px-lg-4" style={{marginBottom: '-44px'}}>
                        <h4>GoPro HERO9 Black</h4>
                            <p>Cuenta con una resolución de video de hasta 5K, fotografías de 20 megapíxeles y estabilización de imagen avanzada </p>
                        </div>
                        </div><a href="./Carrito"></a><a className="btn btn-primary mx-auto" role="button" href="./Carrito" style={{color: 'var(--bs-black)',background: '#ffffff80',borderStyle: 'none'}}></a><a href="./Carrito" style={{paddingRight: '0px',marginRight: '-1px',marginLeft: '0px',paddingLeft: '0px'}}></a><a className="btn btn-primary" role="button" style={{overflow: 'visible', color: 'var(--bs-btn-hover-color)',background: 'var(--bs-btn-disabled-color)', borderColor: 'var(--bs-light)'}} href="Agregado alcarrito.html"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-cart3" style={{fontSize: '33px',background: 'var(--bs-light)',bsBodyColor: 'var(--bs-emphasis-color)',bsBodyBg: 'var(--bs-emphasis-color)',borderColor: 'var(--bs-gray-800)', color: 'var(--bs-emphasis-color)'}}>
                            <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"></path>
                        </svg></a>
...
export default DestacadosVendidos;