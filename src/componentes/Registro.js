            ...
            <div className="collapse navbar-collapse" id="navcol-2" style={{ color: 'var(--bs-black)', fontSize: '20px' }}>
              <div className="collapse navbar-collapse" id="navcol-2">
                <span className="navbar-text" style={{
                  ...
                  fontWeight: 'bold',
                  paddingLeft: '0px',
                  paddingRight: '55px', marginLeft: '18px', marginRight: '-24px'
                }}>Servicio tecnológico&nbsp;</span>
        ...
        <div className="center-container">
          <form style={{ width: '20%', margin: 'auto' }}>
            ...
            <div className="mb-3" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
              <Link to="/Nosotros" style={{ marginRight: '15px' }}>
                <button type="button" className="btn btn-primary" style={{ width: '90%' }}>
                  Atras
                </button>
              </Link>
              <button
              ...
              <Link to="/TablaProductos" style={{ marginRight: '30px' }}>
                <button type="button" className="btn btn-primary" style={{ width: '96%' }}>
                  Continuar
                </button>
              </Link>
            </div>
