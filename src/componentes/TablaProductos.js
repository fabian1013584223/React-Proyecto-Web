...
const TablaProductos = () => {
  return (
    <div className="App">
        <header>
        <nav className="navbar navbar-expand-md py-3 navbar-light" style={{ marginTop: '15px', color: 'var(--bs-cyan)', background: 'var(--bs-link-hover-color)', height: '119px', borderStyle: 'none' }}>
        ...
        <div className="container py-4 py-xl-5">
            <div className="row mb-5">
                <div className="col-md-8 col-xl-6 text-center mx-auto">
                    <h2 style={{color: 'var(--bs-link-hover-color)'}}>Productos</h2>
                    <p></p>
                </div>
            </div>
            <div className="row gy-4 row-cols-1 row-cols-md-2">
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100">
                        <img src={portatil} alt="portatil"style={{width: '284px', height:'214px'}} /> 
                        </div>
                        <div className="py-4 py-lg-0 px-lg-4">
                            <h4>Portatil LG</h4>
                            <p>Descripción del producto.</p>
                        </div>
                        </div><a href="./Carrito"></a><a className="btn btn-primary mx-auto" role="button" href="./Carrito" style={{ color: 'var(--bs-black)', background: '#ffffff80'}}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-cart3" style={{ fontSize: '33px' }}>
                ...
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        ...
                        <img src={Audifonos} alt='Audifonos' style={{ height: '172px', width:'172px' }} />   
                        </div>
                        <div className="py-4 py-lg-0 px-lg-4">
                            <h4>Audífonos&nbsp;</h4>
                            <p>Descripción del producto.</p>
                        </div>
                    </div><a className="btn btn-primary mx-auto" role="button" href="./Carrito" style={{ color: 'var(--bs-black)', background: '#ffffff80'}}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-cart3" style={{ fontSize: '33px' }}>
                            <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"></path>
                        </svg></a>
                </div>
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100">
                        <img src={tabletlenovo} alt="Tabletlenovo"style={{ width:'208px', height:'190px' , PaddingTop: '24px' }} /></div>
                        <div className="py-4 py-lg-0 px-lg-4">
                            ...
                            <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"></path>
                        </svg></a><a href="./Carrito"></a>
                </div>
                <div className="col">
                    <div className="d-flex flex-column flex-lg-row">
                        <div className="w-100">
                        <img src={TecladoMause} alt="TecladoMause"width="208" height="208"style={{ marginBottom: '-44px' }} /></div>
