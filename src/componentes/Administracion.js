                ...
                <div className="container">
                    <div className="row mb-5">
                        <div className="col-md-8 col-xl-6 text-center mx-auto">
                            <h2 style={{color: 'rgb(33, 37, 41)'}}>Administrador</h2>
                            <p>Inicia sesión para poder ingresar a la administración de la empresa.&nbsp;</p>
                        </div>
                    </div>
                            ...
                            <div className="card mb-5">
                                <div className="card-body d-flex flex-column align-items-center">
                                    ...
                                    <form className="text-center" method="post">
                                        ...
                                        <div className="mb-3"><a className="btn btn-primary d-block w-100" role="button" href="./IndexAdmin">Login</a></div>
