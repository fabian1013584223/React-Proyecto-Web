...
import Imagencategoria from "../assets/img/Imagencategoria.png";
import Imagendestacadas from "../assets/img/Imagendestacadas.png";
import Imagenoferta from "../assets/img/Imagenoferta.png";
const index = () => {
  return (
    <div className="App">
        <body>
      ...
      <div className  ="container py-4 py-xl-5">
        <div className="row mb-5">
            <div className="col-md-8 col-xl-6 text-center mx-auto">
                <h2 style={{color:' var(--bs-link-hover-color)'}}>Descubre</h2>
            </div>
        </div>
        <div className="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3">
            <div className="col">
                <div className="text-center d-flex flex-column align-items-center align-items-xl-center">
                    <div className="px-3">
                    <img src={Imagencategoria} alt="Imagencategoria"width="100 "height="80"style={{ height: '80px' }} />
                        <h4 style={{color: 'var(--bs-link-hover-color)'}}>Categoria</h4>
                        <p>Explora nuestra selección tecnológica de primer nivel</p><a className="bounce animated" href="/IndexCategoria">Conocer más&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-arrow-right">
            ...
            <div className="col">
                <div className="text-center d-flex flex-column align-items-center align-items-xl-center">
                    <div className="px-3">
                    <img src={Imagendestacadas} alt="Imagendestacadas" width="107" height="99"></img>
                        <h4 style={{color:' var(--bs-link-hover-color)'}}>Destacados</h4>
                        <p>Descubre los mejores productos tecnológicos en un solo lugar</p><a class="bounce animated" href="./IndexDestacados">Conocer más&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-arrow-right">
                                    <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"></path>
                                </svg></a>
                    </div>
                </div>
            ...
            <div className="col">
                <div className="text-center d-flex flex-column align-items-center align-items-xl-center">
                    <div className="px-3">
                    <img src={Imagenoferta} alt="Imagenoferta" width="114" height="106"></img>
                         <h4 style={{color: 'var(--bs-link-hover-color)'}}>Ofertas</h4>
                         <p>Aprovecha nuestras irresistibles ofertas tecnológicas</p><a className="bounce animated" href="./IndexOfertas">Conocer más&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-arrow-right">
                                    <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"></path>
                                </svg></a>
                    </div>
                </div>
